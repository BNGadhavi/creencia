...
<script type="text/javascript">
   ...
   var submiturl = member_url+"ChangePassword/UpdateChangePassword";
   var confirmbox = true;
   var reporturl = member_url+"ChangePassword";
...
<script type="text/javascript" src="<?php  echo $this->config->item('base_url');?>assets/js/custom/changepassword.js"></script>
