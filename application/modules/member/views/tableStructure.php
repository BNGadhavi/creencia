	  	...
	  	foreach ($data[$i] as  $key => $value) {
			...
			if($counter == 1){ //For Creating th
	      		...
	      		else
      			{
      				...
      				if(@$explode[1] == "convertdate" || @$explode[1] == "convertdatetime") $key=@$explode[0];
      		...
      		else
      		{
		      	...
		      	if(@$explode[1] == "link"){
		      		...
		      		$value="<a ".$targetblank." href='". $member_url.$value. "''>".$explode[0]."</a>";
		      	}
		      	else if(@$explode[1] == "linkicon"){
		      		$targetblank='';
		      		...
		      		$value = "<a ".$targetblank." href='". $member_url.$value. "'' class='font20'> <i aria-hidden='true' class='".$explode[2]."'></i></a>";
		      		$tdclass = 'text-center';
		      	}
		      	else if(@$explode[1] == "linkjs"){
		      	...
		      	if(@$explode[1] == "imagedisplay"){
		      		if($value!='')
		      		{
		      			$value="<button id='imageId' type='button' class='btn btn-primary waves-effect waves-light proofmodel' imgsrc='".$value."' data-toggle='modal' data-target='#primarymodal'><i class='fa fa-eye'></i></button>";	
		      		}
		      		else{
		      			$value='-------';
		      		}
