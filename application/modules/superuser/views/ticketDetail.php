                ...
                <h4 class="form-header text-uppercase">
                  ...
                  Ticket Detail
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="memberId" name="memberId" required="required" readonly="readonly" value="<?php echo $UserInfo['username']?>">
                    </div>
                  </div>

                   <div class="form-group row">
                    <label for="input-10" class="col-sm-2 col-form-label">Member Name</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="memberName" name="memberName" required="required" readonly="readonly" value="<?php echo $UserInfo['fullname']?>">
                    </div>
                  </div>
                  ...
                  <div class="form-footer">
                      ...
                      <a href="<?php echo $AdminUrl;?>Support/CloseTicket/<?php echo $UserInfo['ticketid']?>">
...
<script type="text/javascript">
    ...
    var submiturl = AdminUrl+"Support/TicketReply";
    var confirmbox = true;
    var reporturl = AdminUrl+"Support/CurrentTicketReport";
...
<script type="text/javascript" src="<?php  echo $this->config->item('base_url');?>assets/js/custom/admin/addticketreply.js"></script>
