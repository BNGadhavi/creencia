              ...
              <form id="NewsForm" method="post" action="#" enctype="multipart/form-data">
                ...
                <h4 class="form-header text-uppercase">
                 ...
                 <div class="form-group row">
                  <label for="input-10" class="col-sm-2 col-form-label">News</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="news" name="news" required="required">
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    var formid="NewsForm";
    var submiturl = AdminUrl+"Utility/NewsMasterSubmit";
    var confirmbox = true;
    var reporturl = AdminUrl+"Utility/NewsList";
    var buttonsStyling = false;

    var confirmoktxt = 'Yes!';
    var confirmtxt = 'You Want To Add News!';
    var submittxt = 'News Added Successfully.';
...
<script type="text/javascript" src="<?php  echo $this->config->item('base_url');?>assets/js/custom/admin/newsform.js"></script>
