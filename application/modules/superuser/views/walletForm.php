...
<div class="content-wrapper">
	<div class="container-fluid">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="WalletForm" method="post" action="#" enctype="multipart/form-data">
                <h4 class="form-header text-uppercase">
                  <i class="fa fa-address-book-o"></i>
                  Capital Wallet Credit / Debit
                </h4>
                <div class="form-group row">
                  <label for="input-10" class="col-sm-2 col-form-label">Entry Type </label>
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="type" id="type" value="Credit" checked="checked">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="type" id="type1" value="Debit">
                 ...
                 <div class="form-group row usersection">
                  <label for="input-10" class="col-sm-2 col-form-label">Member ID</label>
                  <div class="col-sm-10">
                   ...
                   <div class="alert alert-success alert-dismissible" role="alert">
                        <div class="alert-message bal" style="display:none;">
                          <span><strong>Capital Wallet Balance : </strong><span id="bal"></span></span>
                        </div>
                      </div>
                  </div>
                </div>
              ...
              <div class="form-group row">
                <label for="input-10" class="col-sm-2 col-form-label">Remarks</label>
                  <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    var formid="WalletForm";
    var submiturl = AdminUrl+"Wallet/WalletFormSubmit";
    var confirmbox = true;
    var reporturl = AdminUrl+"Wallet/WalletReport";
    var buttonsStyling = false;

    var confirmoktxt = 'Yes!';
    var confirmtxt = 'You Want To Perform Transaction!';
    var submittxt = 'Transaction Done Successfully.';
...
<script type="text/javascript" src="<?php  echo $this->config->item('base_url');?>assets/js/custom/admin/walletform.js"></script>
