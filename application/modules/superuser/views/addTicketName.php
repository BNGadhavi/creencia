        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form id="TicketNameForm" method="post" action="#" enctype="multipart/form-data">
                ...
                <h4 class="form-header text-uppercase">
                 ...
                 <div class="form-group row">
                  <label for="input-10" class="col-sm-2 col-form-label">Ticket Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="ticketName" name="ticketName" required="required">
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    var formid="TicketNameForm";
    var submiturl = AdminUrl+"Support/AddTicketNameSubmit";
    var confirmbox = true;
    var reporturl = AdminUrl+"Support/TicketReport";
    var buttonsStyling = false;

    var confirmoktxt = 'Yes!';
    var confirmtxt = 'You Want To Add Ticket Name!';
    var submittxt = 'Ticket Name Added Successfully.';
...
<script type="text/javascript" src="<?php  echo $this->config->item('base_url');?>assets/js/custom/admin/addticket.js"></script>
